...
lean_object* initialize_Perspective_FluctuationBounds(uint8_t builtin);
...
lean_object* initialize_Perspective_GroupFairness(uint8_t builtin);
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Perspective_FluctuationBounds(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Perspective_EnvyFreeness(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Perspective_GroupFairness(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Perspective_FairnessDynamics(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Perspective_FairRepair(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
