...
// Module: Perspective.LeximinGeodesics
// Imports: public import Init public import Perspective.FairnessAlignmentTradeoff
#include <lean/lean.h>
...
x_4 = l_Rat_instNatCast___lam__0(x_1);
...
{
lean_object* x_1; 
x_1 = lean_mk_string_unchecked("Transfer from max to min utility agents", 39, 39);
return x_1;
}
}
...
{
lean_object* x_1; 
x_1 = lean_mk_string_unchecked("Significant redistribution needed. Follow geodesic path.", 56, 56);
return x_1;
}
}
...
{
lean_object* x_1; 
x_1 = lean_mk_string_unchecked("Near leximin-optimal. Small transfers recommended.", 50, 50);
return x_1;
}
}
...
{
lean_object* x_1; 
x_1 = lean_mk_string_unchecked("Allocation is leximin-optimal. No improvement possible.", 55, 55);
return x_1;
}
}
...
lean_ctor_set_uint8(x_11, sizeof(void*)*5, x_8);
return x_11;
}
}
}
