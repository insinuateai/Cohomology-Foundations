...
<!-- Newest first -->
- 2026-02-02: **Documented axiom proof scope** - Added `.claude/axiom-proof-files.md` listing every Lean file with remaining axioms (from axiom-report). This clarifies proof work required across H1Characterization, Infrastructure, MultiAgent, Perspective, and Theories.
